/*Notes:
1)Let, a = a1 mod m1, a = a2 mod m2, ... a = ak mod mk. Then, theres only one solution in modulo lcm(m1, m2, .., mk).
2)For any x = a mod m, it can be decomposed to, x = a1 mod m1, x = a2 mod m2, .... x = ak mod mk, where all mk are distinct prime factors of m.
*/
using T = __int128;
// ax + by = __gcd(a, b)
// returns __gcd(a, b)
